//
//  GAAddEditAlarmViewController.m
//  G Alarm
//
...
@interface GAAddEditAlarmViewController ()

@end

@implementation GAAddEditAlarmViewController
...
- (void)viewDidLoad
{
    ...
    if (self.editMode)
    {
        ...
        GAAlarmObject * oldAlarmObject = [alarmList objectAtIndex:self.indexOfAlarmToEdit];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    if(self.editMode)
    {
        return 3;//for the delete button
    }
	return 2;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.section == 1)
    {
        ...
        cell.textLabel.text = @"Set Geo-Fence";
    }
    if(indexPath.section == 2)
    {
        cell.backgroundColor = [UIColor colorWithRed:220.0/255 green:20.0/255 blue:60.0/255 alpha:1];
        cell.textLabel.textColor = [UIColor whiteColor];
        cell.textLabel.textAlignment = NSTextAlignmentCenter;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.section == 0)
    {
        if(indexPath.row == 0)
        {
            ...
            GAAlarmLabelEditViewController *labelEditController = [mystoryboard instantiateViewControllerWithIdentifier:@"LabelEditView"];
    ...
    else if(indexPath.section == 1)
    {
        if(indexPath.row == 0)
        {
            ...
            GAAlarmLabelEditViewController *mapViewController = [mystoryboard instantiateViewControllerWithIdentifier:@"MapView"];
...
-(IBAction)saveAlarm:(id)sender
{
    ...
    {
        newAlarmObject = [[GAAlarmObject alloc]init];
